...
def check_drinks(drink_name, drink_ingredients):
    ...
    contains_alcohol = set(drink_ingredients) & ALCOHOLS

    return f"{drink_name} {'Cocktail' if contains_alcohol else 'Mocktail'}"
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    suffix: str = ''
    if unique_ingredients < VEGAN:
        suffix = 'VEGAN'
    elif unique_ingredients < VEGETARIAN:
        suffix = 'VEGETARIAN'
    elif unique_ingredients < KETO:
        suffix = 'KETO'
    elif unique_ingredients < PALEO:
        suffix = 'PALEO'
    elif unique_ingredients < OMNIVORE:
        suffix = 'OMNIVORE'
...
def singleton_ingredients(dishes, intersection):
    ...
    category. `<CATEGORY>` can be any one of: (VEGAN, VEGETARIAN, PALEO, KETO, or OMNIVORE).
    ...
    for ingredients in dishes:
        singletons = singletons | (ingredients - intersection)
