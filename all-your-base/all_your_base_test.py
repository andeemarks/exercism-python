...
class AllYourBaseTest(unittest.TestCase):
    def test_convert_to_base(self):
        self.assertEqual(convert_to_base(1, 2), [1])
        self.assertEqual(convert_to_base(9, 2), [1, 0, 0, 1])
        self.assertEqual(convert_to_base(2, 2), [1, 0])
        self.assertEqual(convert_to_base(3, 2), [1, 1])
        self.assertEqual(convert_to_base(4, 2), [1, 0, 0])
        self.assertEqual(convert_to_base(5, 2), [1, 0, 1])
        self.assertEqual(convert_to_base(6, 2), [1, 1, 0])
        self.assertEqual(convert_to_base(7, 2), [1, 1, 1])
        self.assertEqual(convert_to_base(8, 2), [1, 0, 0, 0])
